...
Ogni lezione è un esercizio concreto che puoi applicare subito, con il tuo smartphone o con la tua reflex.`,
  ...
  lezioni: [
    ...
    { titolo: "Fotografia collo Smartphone", descrizione: "Trucchi professionali per scattare foto incredibili con quello che hai già in tasca." },
...
export default function DemoLumioPage() {
  return <TemplateLumio data={sampleData} locale="it" />;
}
